        ...
        <div class="content-wrapper">
            ...
            <form action="{{ route('invoice.update',['invoice'=>$invoice->id]) }}" method="post" id="invoice-submit">
                ...
                <div class="invoice-box">
                    ...
                    <table class="billing-info">
                       ...
                       {{--  <tr class="td-no-padding">
                        ...
                        <tr class="">
                            <td class="">
                                <label for="compition">
                                    <input type="checkbox" name="compition" {{ ($invoice->customer_type==1) ? 'checked' : '' }} value="1" id="compition" >
                                    Compition
                                </label>
                                <br/>
                    ...
                    <table>
                        <tr>
                            <td>Start Date : <input type="date" name="start_date"  value="{{ $invoice->start_date }}" /> End Date :<input type="date" value="{{ $invoice->end_date }}" name="end_date" /></td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table class="billing-info- center">
                        <tr>
                            <td><a href="{{ route('invoice.email',['id'=>$invoice->id]) }}" class="btn-print-edit">Email</a></td>
                            <td><a href="{{ route('invoice.print',['id'=>$invoice->id]) }}" class="btn-print-edit">Print</a></td>
