...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
            ...
            <form action="{{ route('invoice.store') }}" method="post" id="invoice-submit">
                    ...
                    <table class="billing-info">
                        ...
                        <tr class="td-no-padding">
                            <?php
                                ...
                                $totalInvoice =  App\Models\Invoice::where('invoice_type', 'invoice')->whereDate('created_at', '>=', $start_date)->whereDate('created_at', '<=', $end_date)->count()+1;
                            ...
                            <?php $invoice_no = getFinancialYear($da,"y")."/INV/$totalInvoice"; ?> 
 
                            <td rowspan="" class="td-no-padding">
                                <div class="label">Serial No.: </div>
                                <div class="field-group">
                                    <input type="hidden" name="invoice_no" value="<?= $invoice_no ?>" id="invoice_no_hidden">
                                    <b id="invoice_no_display"><?= $invoice_no ?></b>
                                </div>
                            </td>
