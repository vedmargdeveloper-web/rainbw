      ...
      padding: 3px 5px;
            ...
            <?php
                  ...
                  // dd($supply_address);
                   ...
                   $delivery_details = $invoice->delivery_details ? json_decode($invoice->delivery_details, true) : false;
                   $supply_details = $invoice->supply_details ? json_decode($invoice->supply_details, true) : false;
                   //dd($delivery_details);
                    ...
                    <table class="billing-information" style="width: 100%; table-layout: fixed;">
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><?=  ucfirst($invoice->invoice_type) ?> No:</td>
                              <td colspan="1" style="display: block; width: 150px; height: 15px;" ><?=  $invoice->invoice_no ?></td>
                              <td colspan="4"></td>
                    ...
                    <table class="td-item-table no-border-top- m-width" id="main-table"  cellspacing="0" width="100%"   style=" " >
                          ...
                          <thead>
                            ...
                            <tr class="sub-heading-item" >
                                ...
                                <td rowspan="2">Qty</td>
                                <td rowspan="2"> {{ ucfirst($invoice->dayormonth) }}s </td>
                            ...
                            @endphp
                             ...
                             <tbody class="main-td">
                                <tr class=" item">
                                            ...
                                            <td width="6%" class="green"> {{$invoice_item->discount}}</td>
                        ...
                        @endforeach
                            ...
                            <tr class="center bottom-footer-tr">
                                ...
                                <td id="display-gross-total-amount"> <b>{{ $invoice->net_amount }}</b>
                                </td>
                                <td></td>
                                <td></td>
                                ...
                                <td></td>
                                <td></td>
                                <td id="display-total-tax-amount"> <b> {{ $invoice->total_tax }} </b></td>
                        ...
                        <tr class="bottom">
                            ...
                            <td >
                                <table  style="width: 100%; margin-top: -4px;" >
                                    ...
                                    <tr class="flex-td-">
                                        <td class="" colspan="2" style="text-align: center;"><b style="">Address : {{ $bank_address }}</b></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table class="conditions" style="width: 100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>E.&.O.E.</td>
                          <td>1</td>
                          <td><b><u>All supplies shall be against 100% Advance.<u></b></td>
                        </tr>
                        <tr>
                          <td>2</td>
                          <td style="">Delhi courts shall be the only jurisdiction for any disputes.</td>
                          <td rowspan="3">2</td>
                          <td rowspan="3">Modes of Payment can be IMPS, NEFT, RTGS, Bank Transfer, DD, Pay TM and Cash. However, PayTM and Cash Transaction amount should not exceed 2 Lacs. We discourage Cash Transactions.</td>
                        </tr>
                        <tr>
                          <td>3</td>
                          <td>PAN - AAXFR1185Q</td>
                       ...
                       <thead>
                        <tr>
                          ...
                          <td rowspan="2">3</td>
                         <td rowspan="2">Cheques are subject to clearance only and are accepted only in 30 days advance period of booking date.</td>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
