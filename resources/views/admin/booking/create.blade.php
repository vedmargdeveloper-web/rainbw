                ...
                <div class="invoice-box">
                            ...
                            <td class="left-grid text-center" style="width: 40%;" colspan="2">
                                ...
                                <select name="lead_status">
                                    @foreach($leads as $lead)
                                        <option value="{{ $lead->id }}" {{ ($lead->id==4) ? 'selected' : '' }}>{{ $lead->lead }}</option>
                                    @endforeach
                                </select> 
                            </td>
                    ...
                    <table class="billing-info">
                        <tr class="td-no-padding">
                            ...
                            <td rowspan="" class="td-no-padding" style="display: flex;">
                                 ...
                                 <div class="filed-group">
                                     <select required name="uid" id="booking_unique_id">
                                     <option value="">Please Select </option>
                            ...
                            <td class="text-right td-no-padding" >
                                ...
                                <div class="field-group" style="    padding-right: 37px;">
                                    {{-- <b>{{ date('d.m.Y') }}</b> --}}
                                    <b><span id="change_billing_type">Booking </span> Date :</b>
                        ...
                        <tr class="td-no-padding">
                            ...
                            <?php $invoice_no = "FY".date('y')."-".$invoice_last_y."/GC/BKG/$totalInvoice"; ?> 
