                                    ...
                                    <tr>
                                      <td style="text-align: right; padding-right: 0; "><strong> GSTIN : </strong></td>
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td style="padding-left: 0; padding-top: 0; text-align: left;"><strong > {{ $udyam_reg }}</strong></td>
	                    ...
	                    <table class="billing-information" style="width: 100%;">
	                      <tbody>
	                          ...
	                          <tr>
	                              ...
	                              <td>Bill No.:</td>
	                              <td colspan="1" style="display: block; width: 142px; height: 20px;"><?=  $invoice->invoice_no ?></td>
	                              <td colspan="4"></td>
	                            ...
	                            @endphp
	                             ...
	                             <tbody class="main-td">
	                                <tr class=" item">
	                                            ...
	                                            <td class="gross-amount green" width="8%">{{ $invoice_item->gross_amount }}
	                                            	<?php 
	                                            		$gross_amount_total +=  $invoice_item->gross_amount;
	                                            	?>
	                                            </td>
	                    ...
	                    <table class="billing-info- center">
                    		<tbody>
	                            <tr>
	                                ...
	                                <td style="width: 16%;"><a href="{{ route('booking.print',['id'=>$invoice->id]) }}" class="btn-print-edit">Print</a></td>
