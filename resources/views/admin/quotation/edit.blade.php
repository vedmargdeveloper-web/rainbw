                ...
                <div class="invoice-box">
                                                ...
                                                <div class="field-group td-city-width">
                                                    <select class="select-2 invoice-delivery-address" name="delivery_id" >
                                                        <option value=""> Select Delivery Address</option>
                                                            ...
                                                            @endforeach   
                                                            <option value="other" {{ ($invoice->delivery_id == 'other') ? 'selected' : ''  }}>Other</option>
                                                    </select>
                                                </div>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                        <td style="width: 50%;" class="td-no-padding">
                                                            ...
                                                            <div class="field-group">
                                                                <select class="form-control-" name="occasion_id" readonly="readonly">
                                                                        @foreach($occasion as $st)
                                                                                <option value="{{ $st->id }}"  {{ ( $invoice->occasion_id == $st->id ) ? 'selected=""' :'' }}>{{ $st->occasion }} </option>
                                                                        @endforeach
                                                                </select>
                                                            </div>
                                                        </td>
                                                        <td class="td-no-padding">
                                                            ...
                                                            <div class="field-group td-whatsapp">
                                                                <input type="text" class="ml-2" name="creadyness" style="width: 81%;" value="{{ $customers_details['creadyness'] ?? '' }}" class="w-100" required="">
                                                            </div>
                                                        </td>
                                                    <tr>
                                                    </tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="td-no-padding">
                                                                            ...
                                                                            <div class="field-group">
                                                                                ...
                                                                                <input type="text" name="readyness" value="{{ $invoice->readyness ?? '' }}" > 
                                                                            </div>
                                                                        </td>
                                                                    <tr>
                                                                  {{--   <tr>
                    ...
                    <table class="table-grid td-item-table no-border-top" cellspacing="0">
                        ...
                        <tr class="center item">
                                    ...
                                    <td class="my-discount"><input class="td-input-width item-discount"  type="number" name="pdiscount[]"  value="{{ $invoice_item->discount }}"/></td>
 ...
 --}}
                            ...
                            <tr>
                                ...
                                <td colspan="11">
                                    ...
                                    <input name="amount_in_words" id="amount_in_words" type="hidden" value="{{ $invoice->amount_in_words }}" class="w-100" ></td>
                                <tr>
                                    <td colspan="3" style="text-align: right;">Remark </td>
                                    <td colspan="11"><input name="remark" id="remark" type="text" value="{{ $invoice->remark }}" class="w-100" ></td>
                                </tr>
                            </tr>
