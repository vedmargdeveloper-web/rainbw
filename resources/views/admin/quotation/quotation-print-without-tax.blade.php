                ...
                <div class="invoice-box-">
                  <div class="invoce-table-bord">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td class="center" colspan="2">
                                            <b><u>{{ ($invoice->invoice_type == 'quotation') ? 'Proforma Invoice' : '' }}</u></b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="center" colspan="2">
                    ...
                    <table class="billing-information" style="width: 100%; table-layout: fixed;">
                      <tbody>
                          <tr>
                              ...
                              <td  style="background: unset;border: unset; width: 100%; display: block;text-align: center">{{ ($invoice->invoice_type == 'quotation') ? 'Prf Inv' : '' }} Date:</td>
                          ...
                          <tr>
                              ...
                              <td>Prf Inv No:</td>
                              <td colspan="1" style="display: block; width: 117px; height: 15px;"><?=  $invoice->invoice_no ?></td>
                              <td colspan="4"></td>
                          ...
                          <tr>
                              <td>Customer Type: </td>
                              <td style="display: block; width: 25px; height: 15px;">{{ $edit_customer_type->code ?? '' }}</td>
                          ...
                          <tr>
                            ...
                            @endphp
                              ...
                              <td>Occasion :  </td>
                              <td colspan="1" style="font-size:9px;" >@foreach($occasion as $st)
                                    @if($invoice->occasion_id == $st->id)
                                        {{ $st->occasion }}
                                    @endif
                              @endforeach</td>
                              
                              <td>Readyness</td>
                              <td>{{ $customers_details['creadyness'] ?? ''  }}</td>
                          </tr>
                      </tbody>
                            ...
                            @endphp
                             ...
                             <tbody class="main-td">
                                <tr class=" item">
                                            ...
                                            <td class="cgst green" width="5%">{{ 0 }}</td>
                                            <td class="sgst green" width="5%">{{ 0 }}</td>
                                            <td class="igst green" width="5%">{{ 0 }}</td>
                                            <td class="tax-amount green" width="6%">{{ 0 }} </td>
                                            <td class="total-amount " width="9%">{{ round($invoice_item->gross_amount)-$invoice_item->discount }}</td>
                                </tr>
                              </tbody>
                              @php
                                $gdiscount += $invoice_item->discount;
                              @endphp
                        @endforeach
                            ...
                            <tr>
                                ...
                                <td colspan="11" class="green" style="font-weight: 600; text-align: left;"><span id="amountinword">
                                    ...
                                    @if( ($invoice->net_amount-$gdiscount) == 0)  Zero @else {{ getIndianCurrency($invoice->net_amount-$gdiscount) }}
                                    @endif
                                    </span> 
                                    {{-- {{ getIndianCurrency($invoice->net_amount-$gdiscount)  }} --}}
                                </span></td>
                            </tr>
                            <tr>
                    ...
                    <table class="bank-detail" width="100%" style="border-top: 1px solid #000!important; border-bottom:  1px solid #000!important;">
                            <tr class="bottom">
                                <td class="" style="width: 40%; border-right: 1px solid #000;">
                    ...
                    @include('admin.quotation.footer-term-conditions')

                    <center> <p class="center" style="font-size: 12px; padding-bottom: 5px;">This is a system generated {{ ($invoice->invoice_type == 'quotation') ? 'Proforma Invoice' : '' }} and does not require a signature.</p></center>
                </div>
              </div>
