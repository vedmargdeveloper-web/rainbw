                    ...
                    <table cellpadding="0" class="invoice-header" cellspacing="0">
                        <tr class="top">
                            <td class="left-grid text-center" style="width: 40%;" colspan="2">
                                <b>Lead Status</b>
                                <span id="dynamic_lead_status"></span>
                        ...
                        <tr class="td-no-padding">
                            ...
                            <td rowspan="" class="td-no-padding" style="display: flex;">
                                 ...
                                 <div class="filed-group">
                                     <select required name="uid" id="quotation_unique_id" class="quotation_uid">
                                     <option value="">Please Select </option>
                            ...
                            <td class="text-right td-no-padding" >
                                ...
                                <div class="field-group" style="    padding-right: 37px;">
                                    {{-- <b>{{ date('d.m.Y') }}</b> --}}
                                    <b><span id="change_billing_type">Quotation </span> Date :</b>
                        ...
                        <tr class="td-no-padding">
                            ...
                            <td class="text-right td-no-padding">
                                ...
                                <div class="field-group" style="    padding-right: 37px;">
                                   {{--  <b>{{ date('d.m.Y') }}</b> --}}
                                   <b>Event Date :</b>
                                    <input type="date" name="event_date" value="{{ date('d.m.Y') }}">
                                </div>
                            </td>
                        </tr>
                        <tr class="td-no-padding">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="field-group">
                                                    <select class="select-2 invoice-customer-type mandatory" > 
                                                        <option value=""></option>   
                                                    </select>
                    ...
                    <table class="table-grid td-item-table no-border-top" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="center item">
                                    ...
                                    <td class="item_rate">
                                        <input class="td-input-width item-gross-total"  type="number" name="prate[]" value="0" required  />
                                    </td>
