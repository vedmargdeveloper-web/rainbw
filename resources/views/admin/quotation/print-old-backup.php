            ...
            <form action="{{ route('invoice.update',['invoice'=>$invoice->id]) }}" method="post" id="invoice-submit">
                ...
                <div class="invoice-box-">
                    ...
                    <table class="billing-information" style="width: 100%;">
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td  style="background: unset;" ></td>
                              <td colspan="4" style="background: unset;text-align: right; border: 0;">Delivery Address</td>
                          </tr>
                          <tr>
                              <td>Client</td>
                    ...
                    @php 
                        ...
                        $pitchLastest =  $invoice->pitchLastest ? $invoice->pitchLastest : [];
                    ...
                    <table class="table-grid td-item-table no-border-top- m-width"  cellspacing="0" width="100%"   style="table-layout:fixed; margin-top: -2px;" >
                        ...
                        @endforeach
                            ...
                            <tr>
                                ...
                                <td colspan="11" class="green" style="font-weight: 600;"><span id="amountinword">{{ ucfirst($invoice->amount_in_words) ?? '' }}</span></td>
                            </tr>
