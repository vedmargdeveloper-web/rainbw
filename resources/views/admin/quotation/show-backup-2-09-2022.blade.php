                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="field-group">
                                                    <input type="text" class="form-control- w-100"  name="caddress" value="{{ $customer['ccaddress'] ?? '' }}" >
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                            ...
                                                            <div class="field-group ml-2">
                                                                <div class="ccity-div"  style=" margin-left: -6px;">
                                                                    ...
                                                                    {{-- @foreach($city as $st)
                                                                        ...
                                                                        @endphp
                                                                    @endforeach --}}
                                                            <input type="text" name="ccity" value="{{ $customer['ccity'] ?? '' }}">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <div class="field-group state-select">
                                                               {{--  @foreach($state as $st)
                                                                            ...
                                                                            @endphp
                                                                @endforeach --}}
                                                                <input type="text" name="cstate" value="{{  $customer['cstate'] ?? ''  }}">                  
                                                            </div>
                                                        </td>
                                                    <tr>
                                                    </tbody>
