...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
                        ...
                        <tr class="td-no-padding">
                            ...
                            <td rowspan="" class="td-no-padding">
                                ...
                                <div class="field-group">
                                    <select class="" name="unique_id" id="inquiry_unique_id">
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                        <td style="width: 50%;" class="td-no-padding">
                                                            ...
                                                            <div class="field-group">
                                                                  <input type="number" class="w-100" name="cmobile" id="customer_mobile" value=""  required=''>
                                                            </div>
                                                        </td>
                                                        <td class="td-no-padding">
                                                            <div class="label label-whatsapp label-state">WhatsApp</div> 
                                                            <div class="field-group td-whatsapp">
                                                                <input  type="number" class="w-100" name="cwhatsapp" value=""  required=''>
                                                            </div>
                                                        </td>
                                                    <tr>
                                                    </tbody>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="field-group">
                                                    <input type="text" name="remark" class="input-remark" >
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <table class="table-grid td-item-table no-border-top" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="center item">
                                    ...
                                    <td ><input type="text"  class="w-100" name="time_two[]" value="" /></td>
            ...
            <a href="#" class="history-btn" style="display: none;">Show History</a>
