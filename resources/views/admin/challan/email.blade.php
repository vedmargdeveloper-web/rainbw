        ...
        top: -10px; position: relative;
            ...
            <form action="{{ route('invoice.update',['invoice'=>$invoice->id]) }}" method="post" id="invoice-submit">
                ...
                <div class="invoice-box-">
                    ...
                    <table class="table-grid td-item-table no-border-top- m-width"  cellspacing="0" width="100%"   style="table-layout:fixed; margin-top: -2px;" >
                            ...
                            @endphp
                             ...
                             {{-- {{ var_dump($invoice_item) }} --}}
                                <tr class=" item">
                                            ...
                                            <td class="hsn-" width="8%">{{ $challan_item->hsn_code ?? '' }}</td>
                                           
                                            <td class="item-display" width="14%">{{ $challan_item->description ?? '' }}</td>
                                            ...
                                            <td class="item_qty green" width="4%">{{ $challan_item->quantity  ?? '' }}</td>
                                            <td class="item_pday green" width="6%"> {{ $challan_item->days ?? '' }}
                                            </td>
                                            <td class="gross-amount green" width="8%">{{ $challan_item->gross_amount }}</td>
                                            ...
                                            <td class="tax-amount green" width="6%">{{ $challan_item->tax_amount }} </td>
                        ...
                        @endforeach
                            ...
                            <tr>
                                ...
                                <td colspan="11"><span id="amountinword">{{ ucfirst($challan->amount_in_words) ?? '' }}</span></td>
                            </tr>
                    ...
                    <center> <p class="center">This is a system generated {{ $challan->challan_type }} and does not require a signature.</p></center>
                </div>
            ...
            <script type="text/javascript" src="{{ asset('resources/js/jallan.js?v='.time()) }}"></script>
