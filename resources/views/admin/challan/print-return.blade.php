                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="display: flex; text-align: center; position: relative;">
                                                ...
                                                <small style="position: absolute; right: 0;">{{ $copyLabel }}</small>
                                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>Challan Type:</td>
                                <td colspan="1" style="display: block; width: 150px; height: 15px;">
                                    @if ($challan->challan_type == 'challan')
                                        Delivery Challan
                                    @elseif ($challan->challan_type == 'return-challan')
                                        Return Challan
                                    @else
                   ...
                   <table class="bank-detail" width="100%" 
                    ...
                    <center>
                        <p class="center" style="padding-bottom: 10px;">This is a system generated
                            {{ $challan->invoice_type }} and does not require a signature.</p>
                    </center>
                </div>
