...
@section('title', 'Create Returnable Challan')
                ...
                <div class="invoice-box">
                    ...
                    <table class="billing-info">
                                     ...
                                     <select name="challan_type" class="field-group select-2" style="width: 150px;" required>
                                        ...
                                        @foreach($challanTypes as $type)
                                            <option value="{{ $type->type_name }}" 
                                                {{ $type->type_name == 'Returnable Challan - Given on Rent' ? 'selected' : '' }}>
                                                {{ $type->type_name }}
                                            </option>
                                        @endforeach
                        ...
                        ?>
                         <tr class="td-no-padding">
                            <td rowspan="" class="td-no-padding">
                                ...
                                <input type="date" name="start_date" id="global_start_date" value="{{  $currentDate }}"/> </td>
                             <td class="text-right td-no-padding">
                            </td>
                        ...
                        <tr class="td-no-padding">
                          ...
                          <input type="date" name="end_date" id="global_end_date" value="{{  $currentDate }}" /></td>
                             <td class="text-right td-no-padding">
                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                              ...
                                              <div class="field-group">
                                                   <select class="select-2 invoice-customer-type" name="customer_id"> 
                                                        @foreach($customers as $customer)
                                                            {{-- <option value="{{ $customer->id }}" 
                                                                {{ $customer->company_name == 49 ? 'selected' : ($customer->id == $challan->customer_id ? 'selected' : '') }}>
                                                                {{ $customer->company_name }}
                                                            </option> --}}
                                                            <option value="{{ $customer->id }}"
                                                                {{ ($customer->id == 49 && $customer->company_name == 'RAINBOW') ? 'selected' : ($customer->id == $challan->customer_id ? 'selected' : '') }}>
                                                                {{ $customer->company_name }}
                                                            </option>
                                                ...
                                                <div class="field-group td-city-width">
                                                   <select class="select-2 invoice-delivery-address" name="delivery_id">
                                                        ...
                                                        @foreach($delivery_address as $da)
                                                            <option value="{{ $da->id }}"
                                                                {{ $da->id == 196 ? 'selected' : ($da->id == $challan->delivery_id ? 'selected' : '') }}>
                                                                {{ $da->venue }}
                                                            </option>
                                                        @endforeach   
                                                        <option value="other" {{ $challan->delivery_id == 'other' ? 'selected' : '' }}>Other</option>
                                                    </select>
                                                </div>
                                            </td>
                                        </tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%;" >
                                                            ...
                                                            <div class="field-group ml-2">
                                                                <div class="ccity-div"><input type="text" name="ccity" class="custom-pincode" value="" ></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                        <td style="width: 50%;" class="td-no-padding">
                                                            ...
                                                            <div class="field-group">
                                                                <input type="text" name="cpincode" value="" class="custom-pincode">
                                                            </div>
                                                        </td>
                                                        <td class="td-no-padding">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-no-padding">
                                                            ...
                                                            <div class="field-group td-whatsapp">
                                                                <input type="text"  name="creadyness" value="" class="w-100" required="">
                                                            </div>
                                                        </td>
                                                    <tr>
                                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="label">Mobile :</div> 
                                                <div class="field-group width-full">
                                                    <input type="text" class="w-100" name="dmobile" value="" >
                                                </div>
                                            </td>
                                        </tr>
                                          <tr>
                                                                  ...
                                                                  <tbody>
                                                                    <tr>
                                                                        <td style="width: 50%;" class="td-no-padding" >
                                                                            <div class="label">Pincode :</div> 
                                                                            <div class="field-group">
                                                                                <input type="text" class="w-75" name="dpincode" value="" > 
                                                                            </div>
                                                                        </td>
                                                                        <td class="td-no-padding">
                                ...
                                <table>
                                    <tr>
                                        <td class="title center">
                                            ...
                                            <select class="select-2 invoice-supply-address" name="supply_id">
                                            <option value="">Select Supply Address</option>
                                            @foreach($supply_address as $da)
                                                <option value="{{ $da->id }}" 
                                                    {{ $da->id == $challan->delivery_id ? 'selected' : '' }}>
                                                    {{ $da->venue }} {{ $da->address }}
                                                </option>
                                            @endforeach    
                                        </select>
...
<script>
    ...
    $('.invoice-supply-address').find('option[value={{ $challan->delivery_id }}]').attr("selected",true);
   ...
   // $('input[name="customer_type"]').change();
        ...
        // } 
        if ($('input[name="daddress"]').val() == '') {
                $(".invoice-delivery-address").val("196").trigger("change");
            }
